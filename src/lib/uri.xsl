<?xml version="1.0"?>
<!--
As the Inline XBRL processor only needs to import this one file (uri.xsl)
from the "XSLT Standard Library", I've copied the ANNOUNCE text here
(including license info (LGPL)):
